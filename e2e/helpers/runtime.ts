...
export const E2E_SERVER_ENV = {
  ...
  RATE_LIMIT_ADMIN_SIGNIN_EMAIL_IP_LIMIT: "2",
  RATE_LIMIT_ADMIN_SIGNIN_EMAIL_IP_WINDOW_SECONDS: "60",
  RATE_LIMIT_ADMIN_SIGNIN_IP_LIMIT: "3",
  RATE_LIMIT_ADMIN_SIGNIN_IP_WINDOW_SECONDS: "60",
