...
const REPOSITORY_MODULE = "invitation-codes.repository";
...
export async function listInvitationCodes(): Promise<InvitationCodeListItem[]> {
  return logRepositoryOperation(
    ...
    async () => {
      ...
      const redemptionsByCodeId = new Map<
        string,
        InvitationCodeRedemptionDetail[]
      >();
  ...
  return logRepositoryOperation(
    {
      context: {
        ...
        hasMaxUses: input.maxUses !== null && input.maxUses !== undefined,
        purpose: input.purpose,
      },
      module: REPOSITORY_MODULE,
      operation: "createInvitationCode",
    },
    async () => {
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "updateInvitationCodeActiveState",
    },
    async () => {
      const [invitationCode] = await sql<InvitationCodeRow[]>`
