...
const REPOSITORY_MODULE = "clubs.repository";
  ...
  return logRepositoryOperation(
    {
      context: { userId },
      module: REPOSITORY_MODULE,
      operation: "listDiscoverablePublicClubs",
    },
    async () => {
      const rows = await sql<ClubSummaryRow[]>`
        select
  ...
  return logRepositoryOperation(
    {
      context: { userId },
      module: REPOSITORY_MODULE,
      operation: "listManageableClubsForUser",
    },
    async () => {
      const rows = await sql<ClubSummaryRow[]>`
        select
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "listManageableClubBookTargetsByGoogleVolumeIds",
    },
    async () => {
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "listManageableClubBookTargetsForGoogleVolumeId",
    },
    async () => {
      const targetsByVolumeId =
        await listManageableClubBookTargetsByGoogleVolumeIds(userId, [
          googleVolumeId,
        ]);
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "listShelfImportSourcesForClub",
    },
    async () => {
    ...
    () =>
      sql.begin(async (tx) => {
        ...
        if (club.visibility !== "PUBLIC") {
          throw new ClubError(
            "FORBIDDEN",
            "Private clubs require an invitation.",
          );
        }
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "changeClubMemberRole",
      transactional: true,
    },
    () =>
      sql.begin(async (tx) => {
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "transferClubOwnership",
      transactional: true,
    },
    () =>
      sql.begin(async (tx) => {
  ...
  return logRepositoryOperation(
    {
      context: {
        addedById: input.addedById,
        bookIdCount: input.bookIds.length,
        bookIds: input.bookIds,
        clubId: input.clubId,
        status: input.status,
      },
      module: REPOSITORY_MODULE,
      operation: "addBooksToClub",
      transactional: true,
    },
    async () => {
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "createClubInvitation",
      transactional: true,
    },
    () =>
      sql.begin(async (tx) => {
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "revokeClubInvitation",
      transactional: true,
    },
    () =>
      sql.begin(async (tx) => {
...
export async function findInvitationByToken(token: string) {
  return logRepositoryOperation(
    {
      module: REPOSITORY_MODULE,
      operation: "findInvitationByToken",
    },
    async () => {
      const rows = await sql<InvitationLookupRow[]>`
        select
  ...
  return logRepositoryOperation(
    {
      ...
      module: REPOSITORY_MODULE,
      operation: "acceptClubInvitation",
      transactional: true,
    },
    () =>
      sql.begin(async (tx) => {
